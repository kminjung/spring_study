...
<ul>
	...
	<li><a href="json/test03.do">JSON 문자열 응답3</a></li>
	<li><a href="json/test04.do">JSON 문자열 응답4</a></li>
	<li><a href="json/test05.do">JSON 문자열 응답5</a></li>
	<li><a href="json/test06.do">JSON 문자열 응답6</a></li>
</ul>
