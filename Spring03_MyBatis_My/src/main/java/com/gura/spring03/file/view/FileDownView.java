 ...
 *  
 *  - AbstractView 추상 클래스를 상속받아서 만든다.
...
@Component("fileDownView") // 빈의 이름을 문자열로 전달한 것. 보통 클래스명의 첫글자를 소문자로 해서 빈의 이름을 만든다.
public class FileDownView extends AbstractView{ // AbstractView - 클라이언트에게 응답할 수 있는 view

	@Override
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		//여기로 forward 이동시켜서 응답할 수 있다.
		//forward 이동을 할 때 jsp 페이지가 필요없을 때 (파일정보를 다운받을 때)
